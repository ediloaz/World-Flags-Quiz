      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          <div className="flex justify-between items-center flex-wrap gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-800">🏆 Ranking Global - World Flags Quiz</h1>
              <h2 className="text-lg text-gray-600 mt-2">Consulta los mejores jugadores del Global Flag Quiz Game</h2>
            </div>
            <button
              onClick={() => router.push("/")}
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="px-4 py-2 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                aria-label="Filtrar por cantidad de banderas"
              >
                <option value="all">Todas</option>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          {loading ? (
            <div className="p-12 text-center">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4" role="status" aria-label="Cargando ranking"></div>
